...
fs.readFile(audioFilePath, (err, data) => {
    ...
    .on('complete', function() {
        ...
        fs.writeFile('loudness.json', json, 'utf8', function (err) {
            if (err) {
                console.log("An error occured while writing Loudness JSON Object to File.");
