...
export default function energy(essentia, Meyda, audioURL, audioContext) {
    ...
    getFile(audioContext, audioURL).then((audioBuffer) => {
        ...
        .on('complete', function() {
            ...
            violinDistributionPlot(meyda_plot, {0:["meyda", this[0].stats.sample, "green"]}, "Time distribution Energy - Meyda");
            violinDistributionPlot(ess_plot, {0:["essentia.js",this[1].stats.sample, "red"]}, "Time distribution Energy - Essentia");
